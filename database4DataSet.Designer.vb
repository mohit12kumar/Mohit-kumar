...
Partial Public Class database4DataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal book_name As String, ByVal book_id As String, ByVal price As String, ByVal subject As String, ByVal quantity As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, book_name, book_id, price, subject, quantity}
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `book name` IS NULL) OR (`"& _ 
                ...
                "= 1 AND `price` IS NULL) OR (`price` = ?)) AND ((? = 1 AND `subject` IS NULL) OR"& _ 
                " (`subject` = ?)) AND ((? = 1 AND `quantity` IS NULL) OR (`quantity` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`book name`, `book id`, `price`, `subject`, `quantity`) VAL"& _ 
                "UES (?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `book name` = ?, `book id` = ?, `price` = ?, `subject` = ?, `"& _ 
                "quantity` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `book name` IS NULL) OR (`book n"& _ 
                "ame` = ?)) AND ((? = 1 AND `book id` IS NULL) OR (`book id` = ?)) AND ((? = 1 AN"& _ 
                "D `price` IS NULL) OR (`price` = ?)) AND ((? = 1 AND `subject` IS NULL) OR (`sub"& _ 
                "ject` = ?)) AND ((? = 1 AND `quantity` IS NULL) OR (`quantity` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApp2.My.MySettings.Default.database4ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, [book name], [book id], price, subject, quantity FROM Table1"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_book_name As String, ByVal Original_book_id As String, ByVal Original_price As String, ByVal Original_subject As String, ByVal Original_quantity As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal book_name As String, ByVal book_id As String, ByVal price As String, ByVal subject As String, ByVal quantity As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal book_name As String, ByVal book_id As String, ByVal price As String, ByVal subject As String, ByVal quantity As String, ByVal Original_ID As Integer, ByVal Original_book_name As String, ByVal Original_book_id As String, ByVal Original_price As String, ByVal Original_subject As String, ByVal Original_quantity As String) As Integer
            If (book_name Is Nothing) Then
