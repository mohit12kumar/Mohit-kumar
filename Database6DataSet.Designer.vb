...
Partial Public Class Database6DataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal student_name As String, ByVal section As String, ByVal _class As String, ByVal gender As String, ByVal course As String, ByVal address As String, ByVal city As String, ByVal phone_number As String, ByVal photo() As Byte) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, student_name, section, _class, gender, course, address, city, phone_number, photo}
    ...
    Partial Public Class Table1Row
        ...
        Public Property student_name() As String
            Get
                Try 
                    Return CType(Me(Me.tableTable1.student_nameColumn),String)
            ...
            End Get
            Set
                Me(Me.tableTable1.student_nameColumn) = value
            End Set
        End Property
        ...
        Public Property section() As String
            Get
                Try 
                    Return CType(Me(Me.tableTable1.sectionColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'section' in table 'Table1' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTable1.sectionColumn) = value
            End Set
        End Property
        ...
        Public Function Isstudent_nameNull() As Boolean
            Return Me.IsNull(Me.tableTable1.student_nameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub Setstudent_nameNull()
            Me(Me.tableTable1.student_nameColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function IssectionNull() As Boolean
            Return Me.IsNull(Me.tableTable1.sectionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetsectionNull()
            Me(Me.tableTable1.sectionColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace Database6DataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `student name` IS NULL) OR"& _ 
                " (`student name` = ?)) AND ((? = 1 AND `section` IS NULL) OR (`section` = ?)) AN"& _ 
                "D ((? = 1 AND `class` IS NULL) OR (`class` = ?)) AND ((? = 1 AND `gender` IS NUL"& _ 
                "L) OR (`gender` = ?)) AND ((? = 1 AND `course` IS NULL) OR (`course` = ?)) AND ("& _ 
                "(? = 1 AND `address` IS NULL) OR (`address` = ?)) AND ((? = 1 AND `city` IS NULL"& _ 
                ") OR (`city` = ?)) AND ((? = 1 AND `phone number` IS NULL) OR (`phone number` = "& _ 
                "?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`student name`, `section`, `class`, `gender`, `course`, `ad"& _ 
                "dress`, `city`, `phone number`, `photo`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `student name` = ?, `section` = ?, `class` = ?, `gender` = ?,"& _ 
                " `course` = ?, `address` = ?, `city` = ?, `phone number` = ?, `photo` = ? WHERE "& _ 
                "((`ID` = ?) AND ((? = 1 AND `student name` IS NULL) OR (`student name` = ?)) AND"& _ 
                " ((? = 1 AND `section` IS NULL) OR (`section` = ?)) AND ((? = 1 AND `class` IS N"& _ 
                "ULL) OR (`class` = ?)) AND ((? = 1 AND `gender` IS NULL) OR (`gender` = ?)) AND "& _ 
                "((? = 1 AND `course` IS NULL) OR (`course` = ?)) AND ((? = 1 AND `address` IS NU"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApp2.My.MySettings.Default.Database6ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, [student name], [section], class, gender, course, address, city, [phon"& _ 
                "e number], photo FROM Table1"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database6DataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database6DataSet.Table1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database6DataSet.Table1DataTable = New Database6DataSet.Table1DataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database6DataSet.Table1DataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_student_name As String, ByVal Original_section As String, ByVal Original_class As String, ByVal Original_gender As String, ByVal Original_course As String, ByVal Original_address As String, ByVal Original_city As String, ByVal Original_phone_number As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal student_name As String, ByVal section As String, ByVal _class As String, ByVal gender As String, ByVal course As String, ByVal address As String, ByVal city As String, ByVal phone_number As String, ByVal photo() As Byte) As Integer
